...
\begin{frame}[fragile]
	...
	Deep linking is now possible in the TYPO3 backend. This lets users share link
	with other users and it makes working with the backend much more efficient.

	\begin{figure}
		\includegraphics[width=0.90\linewidth]{BackendUserInterface/1618653909-DeepLinkingInTheBackend-3.png}
	\end{figure}
